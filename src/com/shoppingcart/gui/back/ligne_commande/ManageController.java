package com.shoppingcart.gui.back.ligne_commande;
...
public class ManageController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        currentLigne_commande = ShowAllController.currentLigne_commande;
        ...
        if (controleDeSaisie()) {
            ...
            if (currentLigne_commande == null) {
                if (Ligne_commandeService.getInstance().add(ligne_commande)) {
                    ...
                    MainWindowController.getInstance().loadInterface(Constants.FXML_BACK_DISPLAY_ALL_LIGNE_COMMANDE);
                } else {
                ...
                if (Ligne_commandeService.getInstance().edit(ligne_commande)) {
                    ...
                    ShowAllController.currentLigne_commande = null;
                    MainWindowController.getInstance().loadInterface(Constants.FXML_BACK_DISPLAY_ALL_LIGNE_COMMANDE);
                } else {
                    AlertUtils.makeError("ligne_commande existe deja");
                }
